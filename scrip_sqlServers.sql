...
-- CREATE TABLE BRANCHES 
 ...
 (
    ...
    address_branch_atm INT NOT NULL --FORENING KEY REFERENCES BRANCHES 
    CREATED_DATE DATETIME NOT NULL,
    UPDATED_DATE DATETIME NOT NULL, 
    FOREIGN KEY (id_branch_atm) REFERENCES BRANCHES(id_branch) -- FOREING KEY REFERENCES BRACHES 
...
(
    ...
    currency_account NVARCHAR CHECK(CURRENCY IN ('USD', 'GTQ'))
